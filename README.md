...
All site content lives in `src/content/` and is editable at **/keystatic**:
...
```bash
npm run dev
# admin at http://localhost:3000/keystatic (local mode)
```
...
1. Create a GitHub OAuth app at https://github.com/settings/developers
   ...
   - Callback URL: `https://your-domain.com/keystatic/api/github/login`
