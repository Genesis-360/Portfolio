...
export default function TestimonialsEditorial({
  ...
  return (
    <section data-slot="testimonials" className="py-12 md:py-16">
      {/* Optional section header */}
      {(heading || description) && (
        <div className="mb-10 max-w-2xl px-6 md:px-0">
      ...
      <div className="w-full max-w-4xl mx-auto px-6 py-4 md:py-6">
